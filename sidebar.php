<div id="sidebar"><div id="sidebar-wrapper"> <!-- Sidebar with logo and menu -->
			...
			?>
			<h1 id="sidebar-title"><a href="#">Welcome Admin</a></h1>
			...
			<ul id="main-nav">  <!-- Accordion Menu -->
				...
				<li> 
					<a href="products.php" class="nav-top-item <?php if(in_array($filename,$pages)):?>current<?php endif;?> <!-- Add the class "current" to current menu item -->
					Products
					</a>
					<ul>
						...
						<li><a <?php if($filename=="category.php"):?>class="current"<?php endif;?> href="category.php">Manage category</a></li>
						<li><a <?php if($filename=="tags.php"):?>class="current"<?php endif;?>href="tags.php">Manage Tags</a></li>
					</ul>
				</li>
				
				<li>
					<a href="users.php" class="nav-top-item <?php if($filename=="users.php"):?>current<?php endif;?>">
						Users
					</a>
					<ul>
				...
				<li>
					<a href="#" class="nav-top-item <?php if(in_array($filename=="#")):?>current<?php endif;?>">
						Settings
					</a>
					<ul>
